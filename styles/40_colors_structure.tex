...
\colorlet{MathHLPrimary}{ChapterColor4}    % Teal  -- Quelle / gegeben / erster Strang
\colorlet{MathHLSecondary}{ChapterColor3}  % Orange -- Gegenstueck / abgeleitet / zweiter Strang
\colorlet{MathHLTertiary}{ChapterColor11}  % Magenta -- dritter paralleler Strang (sparsam)
\colorlet{MathHLTarget}{ChapterColor18}    % Blau  -- Ziel / Endform / Resultat
...
% Aussagen-/Verfahrens-Boxen (statementbox, procedure)
...
% Reduzierter "before skip" fuer Boxen, die direkt nach einer SubsectionBar
% stehen. Das Flag wird per `before app` der Box wieder geloescht.
...
% Hinweis: Wegen tcolorbox \addvspace-Semantik nur SubsectionBar before-skip
% subtrahieren (ChapterBar after-skip wird durch das addvspace verschluckt).
