...
\newcommand{\ZSFTitleHeader}[2]{%
  ...
  \begin{zsftitleheader}
    \sffamily
    {\color{white}\fontsize{7.5bp}{8bp}\bfseries\selectfont #1\,%
    \color{white!85}\fontsize{5.8bp}{6bp}\mdseries\itshape\selectfont \textemdash{}~von~#2\par}%
  \end{zsftitleheader}
  \penalty10000
}
...
\newtcolorbox{subsectionbar}[1][] {
  ...
  top=\ZSFspaceS,
  bottom=\ZSFspaceS,
  before skip=\ZSFsubsectionBarBeforeSkip,
  after skip=\ZSFspaceS,
