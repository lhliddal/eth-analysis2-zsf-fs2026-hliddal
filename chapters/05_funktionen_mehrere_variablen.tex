...
\SubsectionBar{Differentialrechnung in 2D}
...
\paragraph*{Partielle Ableitung \& Gradient}
...
\SubsectionBar{Linearisierung \& Fehlerrechnung (2D \& 3D)}
...
\textVorBox{Der durch die Linearisierung entstehende \ZSFkeyword[Fehler, absoluter@Fehler, absoluter]{absolute Fehler} beträgt:}
\begin{formulabox}
...
\textVorBox{Die allgemeine Formel für den \ZSFkeyword[Fehler, relativer@Fehler, relativer]{relativen Fehler} beträgt:}
\begin{formulabox}
...
\SubsectionBar{Extremalstellen (2D)}
...
\SubsectionBar{Differentialrechnung in 3D}
...
\paragraph*{Tangentialebene \& -fläche}
...
\SubsectionBar{Richtungsableitung \& Kettenregel}
