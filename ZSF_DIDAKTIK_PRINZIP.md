...
- Jede Information muss in Sekunden auffindbar sein — über Box-Titel, Marker (`\ZSFkeyword`, `\ZSFdanger`) und visuelle Struktur, nicht über Fließtext.
...
- Lange Fließtext-Passagen sind ein Warnsignal — solchen Inhalt in `procedure`, `factlist`, Tabellen oder einzelne Boxen umstrukturieren, sodass das Auge beim Überfliegen hängen bleibt.
